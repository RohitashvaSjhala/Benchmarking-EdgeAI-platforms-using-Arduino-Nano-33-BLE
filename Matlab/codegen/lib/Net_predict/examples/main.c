...
static void argInit_150x3_real32_T(float result[450]);

static float argInit_real32_T(void);

/* Function Definitions */
/*
 * Arguments    : float result[450]
 * Return Type  : void
 */
static void argInit_150x3_real32_T(float result[450])
{
 ...
 * Return Type  : void
 */
void main_Net_predict(void)
{
  dlarray out;
  float fv[450];
  /* Initialize function 'Net_predict' input arguments. */
  /* Initialize function input argument 'in'. */
  /* Call the entry-point 'Net_predict'. */
  argInit_150x3_real32_T(fv);
  Net_predict(fv, &out);
}
